...
export const RoleList = () => {
    ...
    const [columns, setColumns] = useState(getData(rolePayload.columnsName) == null ? rolePayload.columns : getData(rolePayload.columnsName));
                                        ...
                                        <Grid container spacing={2} direction="row" sx={{ paddingTop: 1 }}>
                                            ...
                                            <Grid container spacing={0.5} xs={12} sm={12} md={12} lg={7} xl={7} direction="row" justifyContent="flex-start" alignTransferItems="center">
                                                ...
                                                <Grid transferItem xs={1}>
                                                    <TableCustomizeSetting payload={rolePayload.columns} columns={columns} setColumns={(e)=>setColumns(e)} />
                                                </Grid>
                                                ...
                                                {columns.map((column) => {
                                                    ...
                                                    const switchCase = ({ column, value }) => {
                                                        switch (column.id) {
                                                            ...
                                                            case "option":
                                                                return (
                                                                    <NavigateId url={`${paths.role}/${row.id}`} id={row.id} />
                                                                )
                                                            default:
                                                                return value;
                                                        }
