...
export const SroutesList = () => {
  ...
  const [columns, setColumns] = useState(
    getData(sroutesPayload.columnsName) == null
      ? sroutesPayload.columns
      : getData(sroutesPayload.columnsName)
  );
                      ...
                      >
                        <Grid transferItem xs={1}>
                          <TableCustomizeSetting
                            payload={sroutesPayload.columns}
                            columns={columns}
