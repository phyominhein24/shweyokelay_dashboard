...
export const agentService = {
    ...
    destory: async (dispatch, id) => {
        const response = await delRequest(`${endpoints.agent}/${id}`);
        await httpServiceHandler(dispatch, response);
    ...
    exportexcel: async (dispatch, params) => {
        const response = await featchGetRequest(`${baseURL}/${endpoints.agent}/exportexcel`, params)
    ...
    exportexcelparams: async (dispatch, params) => {
        const response = await featchGetRequest(`${baseURL}/${endpoints.agent}/exportexcelparams`, params)
    ...
    exportpdf: async (dispatch, params) => {
        const response = await featchGetRequest(`${baseURL}/${endpoints.agent}/exportpdf`, params, "pdf")
    ...
    exportpdfparams: async (dispatch, params) => {
        const response = await featchGetRequest(`${baseURL}/${endpoints.agent}/exportpdfparams`, params, "pdf")
    ...
    import: async (payload, dispatch) => {
        const response = await postRequest(`${endpoints.agent}/import`, payload);
        await httpServiceHandler(dispatch, response);
