...
export const ContactCreate = () => {
  ...
  const [payload, setPayload] = useState(contactPayload.store);
  ...
  const submitGenre = async () => {
    setLoading(true);
    const formData = formBuilder(payload, contactPayload.store);
    const create = await contactService.store(formData, dispatch);
