...
export const RoutesList = () => {
    ...
    const [columns, setColumns] = useState(getData(routesPayload.columnsName) == null ? routesPayload.columns : getData(routesPayload.columnsName));
                                        ...
                                        <Grid container spacing={2} direction="row" sx={{ paddingTop: 1 }}>
                                            ...
                                            <Grid container spacing={0.5} xs={12} sm={12} md={12} lg={7} xl={7} direction="row" justifyContent="flex-start" alignTransferItems="center">
                                                ...
                                                <Grid transferItem xs={1}>
                                                    <TableCustomizeSetting payload={routesPayload.columns} columns={columns} setColumns={(e)=>setColumns(e)} />
                                                </Grid>

                                                <Grid transferItem xs={2}> 
                                                    <FilterByStatus paginateParams={paginateParams} status={routesStatus} onFilter={onFilter} />
                                                </Grid>
                                                ...
                                                {columns.map((column) => {
                                                    ...
                                                    const switchCase = ({ column, value }) => {
                                                        switch (column.id) {
                                                            ...
                                                            case "option":
                                                                return (
                                                                    <NavigateId url={`${paths.routes}/${row.id}`} id={row.id} />
                                                                )
                                                            default:
                                                                return value;
                                                        }
