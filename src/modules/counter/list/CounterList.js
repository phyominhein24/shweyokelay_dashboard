...
export const CounterList = () => {
    ...
    const [columns, setColumns] = useState(getData(counterPayload.columnsName) == null ? counterPayload.columns : getData(counterPayload.columnsName));
                                        ...
                                        <Grid container spacing={2} direction="row" sx={{ paddingTop: 1 }}>
                                            ...
                                            <Grid container spacing={0.5} xs={12} sm={12} md={12} lg={7} xl={7} direction="row" justifyContent="flex-start" alignTransferItems="center">
                                                ...
                                                <Grid transferItem xs={1}>
                                                    <TableCustomizeSetting payload={counterPayload.columns} columns={columns} setColumns={(e)=>setColumns(e)} />
                                                </Grid>
